...
namespace BiliRoku.Bililivelib
{
    internal class FlvDownloader
    {
        ...
        public FlvDownloader(string roomid, string savePath, string remark, bool saveComment, CommentProvider cmtProvider)
        {
            _savePath = savePath;
            _roomid = roomid;
            _remark = remark;
        ...
        public void Start(string uri)
        {
            ...
            _compiledPath = CompilePath(_savePath, _roomid, _remark);
            IsDownloading = true;
        ...
        public static string CompilePath(string path, string roomid, string remark)
        {
            path = path.Replace("{roomid}", roomid);
            path = path.Replace("{remark}", remark);
